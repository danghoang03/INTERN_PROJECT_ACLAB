...
function onMessage(event) {
    ...
    if(event.data == "RELAY1_ON" || event.data == "RELAY1_OFF") {
        ...
        document.getElementById("1").checked = (state == "Đang hoạt động") ? true : false;
    }
        ...
        document.getElementById("2").checked = (state == "Đang hoạt động") ? true : false;
    }
        ...
        document.getElementById("3").checked = (state == "Đang hoạt động") ? true : false;
    }
        ...
        document.getElementById("4").checked = (state == "Đang hoạt động") ? true : false;
    }
        ...
        document.getElementById("5").checked = (state == "Đang hoạt động") ? true : false;
    }
        ...
        document.getElementById("6").checked = (state == "Đang hoạt động") ? true : false;
    }
}